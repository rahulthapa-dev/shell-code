...
// import blog2 from "@/assets/img/b2.png";
// import blog3 from "@/assets/img/b3.png";
// import exit from "@/assets/img/exit.svg";
// import BgHero from "@/assets/img/bg-main.png";
            ...
            <main>
                <div className="relative bg-[#0D0D0D] top-bg">
                    ...
                    <div className="relative isolate overflow-hidden pb-0 pt-24 space-y-32">
                        <section>
                            <Image src={Element1} alt="background" className="absolute inset-0 -z-10 lg:top-[14%] lg:left-[10%] top-[4%] left-[-6%] lg:w-auto w-[60px]"></Image>
                            <Image src={Element2} alt="background" className="absolute inset-0 -z-10 lg:top-[35%] lg:left-[10%] top-[20%] left-[-5%] lg:w-auto w-[60px]"></Image>
                            <div className="mx-auto max-w-5xl px-6 lg:px-8">
                                <div className="mx-auto pt-16 lg:pt-32">
                                    <div className="mb-8 flex justify-center">
                                        <div className="relative">
                                        <Image className="h-6 xl:h-12 w-auto" src={LogoImage} alt="Shell-Code" />
                                        </div>
                                    </div>
                                        ...
                                        <div className="mt-10 flex items-center justify-center gap-x-6">
                                            <div className="lg:flex gap-x-8 space-y-3 lg:space-y-0">
                                                <a href="" className="text-white font-ibm-regular text-base lg:text-lg flex gap-x-2 items-center">
                                                    <Image src={web} alt="Website development" className="size-5"></Image>
                                                    <span>Website development</span>
                                                </a>
                                                <a href="" className="text-white font-ibm-regular text-base lg:text-lg flex gap-x-2 items-center">
                                                    <Image src={app} alt="App development" className="size-5"></Image>
                                                    <span>App development</span>
                                                </a>
                                                <a href="" className="text-white font-ibm-regular text-base lg:text-lg flex gap-x-2 items-center">
                                                    <Image src={product} alt="Product Design" className="size-5"></Image>
                                ...
                                <div className="mx-auto max-w-7xl px-4 lg:px-8 relative z-10">
                                    ...
                                    <div className="lg:grid lg:grid-cols-12 lg:gap-8">
                                        <div className="mt-0 lg:col-span-6 lg:mt-0 mb-3 lg:mb-0">
                                            <Image src={AboutImage} alt="About image" className="rounded-[34px] lg:rounded-[48px]"></Image>
                                        </div>
                ...
                <section className="bg-gray-950 py-16 service-bg">
                    <div className="mx-auto max-w-7xl px-4 lg:px-8">
                        <div className="flex justify-end pb-20">
                            <Link href="/services" className="h2 font-clash-bold text-white/60 text-[38px] lg:text-4xl xl:text-8xl section-title relative pr-3 lg:pr-56 lg:w-auto inline-block w-full uppercase">Our <br className="inline-block lg:hidden"/> Service</Link>
                        </div>
                ...
                <section className="bg-black py-16 relative">
                    <Image src={union} alt="union bg" className="absolute bottom-0 left-0 w-full lg:max-w-[460px] max-w-[160px]"></Image>
