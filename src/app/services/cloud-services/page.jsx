                ...
                <div className="wrapper lg:overflow-y-auto lg:pb-0" ref={wrapperRef}>
                        ...
                        <div className="mx-auto max-w-7xl px-4 lg:px-8">
                            <div className="lg:grid lg:grid-cols-12 lg:gap-8">
                                <div className="lg:col-span-6">
                                    <h3 className="font-clash-medium text-4xl lg:text-6xl text-white mb-9">Cloud Services</h3>
                                    ...
                                    <div className="bg-gray-400/20 border border-gray-500 rounded-[32px] p-5 max-w-[400px]">
                                        <p className="font-sf text-xl lg:text-3xl text-white mb-2 lg:mb-0">
                                            <em>“We provide freshly baked virtual servers like a pro!”</em>
                                        </p>
                    ...
                    <section className="py-16 bg-[#0D0D0D] ux-research flex items-center">
                        <div className="mx-auto max-w-7xl px-4 lg:px-8 space-y-8 lg:space-y-16">
                            <h3 className="font-clash-bold text-white text-3xl lg:mb-8 text-wrap">Dominate Cloud Computing Kingdom Now!</h3>
                            <p className="font-sf text-xl text-white/80">
                            Imagine a buffet offering a variety of delicious food-like storage, computing power and software, that can make any business go hungry! And the best part of this buffet? You would only pay for what your business desires. Looks pretty cool, right? Grab this deal now by connecting with us. 
                            </p>
                            <div className="lg:grid lg:grid-cols-12 lg:gap-8 mt-8">
                                ...
                                <ul className="lg:col-span-6 text-white ul-custom space-y-1">
                                    ...
                                    <li>
                                    Connection with VMs and other Cloud Resources
                                    </li>
                                </ul>
                            </div>
                        </div>
