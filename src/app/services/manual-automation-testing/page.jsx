                ...
                <div className="wrapper lg:overflow-y-auto lg:pb-0" ref={wrapperRef}>
                        ...
                        <div className="mx-auto max-w-7xl px-4 lg:px-8">
                            <div className="lg:grid lg:grid-cols-12 lg:gap-8">
                                <div className="lg:col-span-6">
                                    <h3 className="font-clash-medium text-4xl lg:text-6xl text-white mb-9">Manual/Automation Testing</h3>
                                    ...
                                    <div className="bg-gray-400/20 border border-gray-500 rounded-[32px] p-5 max-w-[400px]">
                                        <p className="font-sf text-xl lg:text-3xl text-white mb-2 lg:mb-0">
                                            <em>“We are the vigilant guardians of your software.”</em>
                                        </p>
                    ...
                    <section className="py-16 bg-[#0D0D0D] ux-research flex items-center">
                        <div className="mx-auto max-w-7xl px-4 lg:px-8 space-y-8 lg:space-y-16">
                            <h3 className="font-clash-bold text-white text-3xl lg:mb-8 text-wrap"> Turning Nail-Biting Software into Sleek Thrills</h3>
                            <p className="font-sf text-xl text-white/80">
                            Our team is like a Swiss Army of software testing, enabling them to run at the speed of espresso binge. Whether it's manual or automatic testing, we jump up high to roll the dice and make software dance with joy when users engage with it, without any bugs or technical glitches. 
                            </p>
