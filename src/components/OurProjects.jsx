                ...
                <div className="lg:grid lg:grid-cols-12 lg:gap-8 pb-20">
                    <div className="lg:col-span-8">
                        ...
                        <div className="flex flex-wrap gap-x-3">
                            <Link href="/services/mobile-app-development" className="mt-5 text-base lg:text-lg xl:text-2xl text-white font-clash-medium py-2 px-4 lg:px-8 lg:py-3 bg-[#6F0000] border border-white rounded-[79px]">App development</Link>
                            <Link href="/services/web-development" className="inline-flex items-center gap-x-3 mt-5 text-base lg:text-lg xl:text-2xl text-white font-clash-medium py-2 px-4 lg:px-8 lg:py-3 bg-transparent hover:bg-[#6F0000] border border-white border-solid rounded-[79px]">Website development</Link>
                            <Link href="/services" className="inline-flex items-center gap-x-3 mt-5 text-base lg:text-lg xl:text-2xl text-white font-clash-medium py-2 px-4 lg:px-8 lg:py-3 bg-transparent hover:bg-[#6F0000] border border-white border-solid rounded-[79px]">Others</Link>
                        </div>
                    </div>
