...
const ServiceCarousel = () => {
  ...
  return (
    <div className="wrapper overflow-y-auto" ref={wrapperRef}>
      <section className='pt-5 lg:pt-12'>
            <div className="pb-16">
                <div className="mx-auto max-w-7xl px-4 lg:px-8">
                    <div className="lg:grid lg:grid-cols-12 lg:gap-8">
                        <div className="lg:col-span-6">
                            <h3 className="font-clash-medium text-4xl leading-[3rem] lg:text-5xl text-white">Application <br className="lg:hidden inline-block"/> Development</h3>
                        </div>
                        <div className="lg:col-span-6">
