        ...
        <div>
                                ...
                                <header className="inset-x-0 top-0 z-[51]">
                                    <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                                        ...
                                        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
                                            ...
                                            <Link href="/contact" className="inline-flex rounded-3xl py-2 px-3 text-lg font-sf leading-6 text-white bg-custom-gradient">Contact us</Link>
                                            </div>
                                        </div>
                                    </nav>
                                </header>
            ...
            <header className="absolute inset-x-0 top-0 z-50">
                ...
                <div className="flex lg:flex-1">
                    <Link href="/" className="-m-1.5 p-1.5">
                    <span className="sr-only">Shell Code</span>
                    <Image className="h-6 xl:h-10 lg:w-auto w-[108px]" src={LogoImage} alt="Shell-Code" />
                    </Link>
                </div>
                <div className="flex">
